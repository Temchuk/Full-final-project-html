# Веб-сайт компанії кави

Цей проект є веб-сайтом компанії з продажу кави. Він призначений для інформування клієнтів про різноманітні види кави, їх властивості та ціни.
...
Над цим проектом працювали Діана Пацеля, Олена Темчук та Тарас Мазепа.

- Діана Пацеля: Блоки 1 і 2.
- Олена Темчук: Блоки 2 і 3.
- Тарас Мазепа: Блоки 5 і 6.
...
5. Блок 5 (news): Публікує останні новини та пропозиції компанії.
6. Блок 6 (footer): Включає додаткову інформацію, посилання на соціальні мережі та копірайт.
...
This project is a website for a coffee company. The website is designed to inform customers about various types of coffee, their properties, and prices.
...
5. Block 5 (news): Publishes the latest news and offers from the company.
6. Block 6 (footer): Includes additional information, links to social networks, and copyright.

## Installation and Usage

1. Clone the repository to your computer.
2. Open the full-project.html file in your web browser to view the site.
3. The website is responsive and adapted for tablet and mobile versions.